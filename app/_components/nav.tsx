    ...
    >
      ...
      <div className="flex gap-4 items-center">
        <a
          ...
          target={`_blank`}
          rel="noreferrer"
          className="justify-center bg-transparent bg-opacity-25 border border-blue-300 border-opacity-25 text-white flex items-center gap-2 py-2 px-4 font-semibold tracking-normal rounded-2xl transition-colors hover:border-opacity-50 hover:shadow-md"
        >
          <RoughNotation
            type="underline"
            show={showGithub}
        ...
        <a
          ...
          target={`_blank`}
          rel="noreferrer"
          className="bg-blue-400 bg-opacity-25 border border-blue-300 border-opacity-25 text-white flex items-center gap-2 py-2 px-4 font-semibold tracking-normal rounded-2xl transition-colors hover:border-opacity-0 hover:shadow-md justify-center"
        >
          <RoughNotation
            type="underline"
            show={showTwitter}
